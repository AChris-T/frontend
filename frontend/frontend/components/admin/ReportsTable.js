        ...
        <div className="flex flex-wrap gap-2">
          <div className="relative">
            ...
            <input
              ...
              className="rounded-xl border border-border bg-surface-2 py-2 pl-9 pr-3 text-sm text-ink outline-none focus:border-brand"
            />
          </div>
          <select
            value={filterStatus}
            onChange={(e) => setFilterStatus(e.target.value)}
            className="rounded-xl border border-border bg-surface-2 px-3 py-2 text-sm text-ink outline-none focus:border-brand"
          >
